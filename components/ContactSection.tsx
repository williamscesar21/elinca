      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-500 text-lg max-w-2xl mx-auto">
            Nuestro equipo de ingenieros está listo para analizar sus
            necesidades y proponer la mejor solución.
          </p>
        </div>

        <div
          className={`grid grid-cols-1 lg:grid-cols-5 gap-10 transition-all duration-700 delay-200 ${
            inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          {/* Info lateral */}
          <div className="lg:col-span-2 space-y-5">
            ...
            <a
              ...
              className="flex items-center gap-4 bg-white border border-gray-100 hover:border-green-200 hover:shadow-md rounded-2xl p-5 transition-all duration-300 group"
            >
          ...
          <div className="lg:col-span-3">
            <div id="cotizacion" className="bg-white border border-gray-100 rounded-2xl p-8 shadow-sm">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-gray-50 border border-gray-200 focus:border-green-400 focus:ring-2 focus:ring-green-100 rounded-xl px-4 py-3 text-gray-900 text-sm outline-none transition-all placeholder:text-gray-400"
                        placeholder="Juan Pérez"
                        style={{ outlineColor: "#0ADC1E" }}
                      />
                  ...
                  <div>
                    ...
                    <select
                      {...register("sector")}
                      className="w-full bg-gray-50 border border-gray-200 focus:border-green-400 focus:ring-2 focus:ring-green-100 rounded-xl px-4 py-3 text-gray-900 text-sm outline-none transition-all"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full bg-gray-50 border border-gray-200 focus:border-green-400 focus:ring-2 focus:ring-green-100 rounded-xl px-4 py-3 text-gray-900 text-sm outline-none transition-all placeholder:text-gray-400 resize-none"
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full text-white font-semibold py-4 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed"
                    style={{ backgroundColor: "#0ADC1E" }}
                    onMouseEnter={(e) => !submitting && (e.currentTarget.style.backgroundColor = "#08B819")}
                    onMouseLeave={(e) => !submitting && (e.currentTarget.style.backgroundColor = "#0ADC1E")}
                  >
